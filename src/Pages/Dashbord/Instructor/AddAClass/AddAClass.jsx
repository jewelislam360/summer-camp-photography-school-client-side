    ...
    const onSubmit = data => {
        ...
        .then(imgResponse=>{
            ...
            if(imgResponse.success){
                ...
                const newClass = {className, image: imgURL, instructorName, instructorEmail, availableSeats: parseFloat(availableSeats), price: parseFloat(price), status:"pending", enrolledStudent: parseFloat(0)};
